...
export default function MobileNavMenu({ isMobileMenuOpen }: IMobileNavMenuProps) {
            ...
            <div className={`${isMobileMenuOpen && 'act'} bg-gray-200 mobile_nav_bar font-black`}>
                {isMobileMenuOpen && (
                    <>
                        ...
                        <hr />
                        <div className="flex flex-row items-center justify-between px-10 py-7 gap-10">
                            {t('language')}
                            <LocaleSwitcher />
                        </div>
                        <hr />
                        <div className="flex flex-row justify-center items-center p-5">
                            <div className="flex flex-row justify-center items-center gap-6 fixed bottom-0 mb-7 ">
                                <button>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        x="0px"
