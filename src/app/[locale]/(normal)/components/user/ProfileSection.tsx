...
export default function ProfileSection({ profileNFT }: IProfileSectionProps) {
        ...
        <div
            ...
            <div
                ...
                <div className="flex flex-row justify-center items-center gap-6">
                    ...
                    <div
                        className="w-[calc(100%/2-4rem)] flex flex-row justify-between"
                        // onClick={()=> {updateUserProfile()}}
                    >
                        <Popover placement="bottom-end">
                            <PopoverHandler>
                                <div className="cursor-pointer p-3 bg-opacity-20 text-center bg-black rounded-lg">
                                    ...
                                </div>
                            </PopoverHandler>
                            <PopoverContent className="w-72" placeholder={undefined}>
