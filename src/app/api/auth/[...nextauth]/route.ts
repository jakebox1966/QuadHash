    ...
    providers: [
        CredentialsProvider({
            ...
            async authorize(credentials, req) {
                ...
                formData.append('wallet_address', credentials?.eth_address)
                formData.append('wallet_signature', credentials?.eth_signature)
                formData.append('chain_id', credentials?.chain_id)
